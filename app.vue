...
<template>
  <!-- <h1 class="text-3xl font-bold underline bg-black text-asosiy md:text-red-600 font-montserrat">
      Hello world!
    </h1> -->
  <div class="bg-asosiy w-full overflow-hidden font-montserrat container">
